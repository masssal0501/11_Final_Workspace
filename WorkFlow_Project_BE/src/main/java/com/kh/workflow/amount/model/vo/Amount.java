...
public class Amount {
    ...
    // =========================================================
    // 3. WorkcationInfo 연관관계
    //
    // amount.workcation_no
    //        ↓
    // workcation_info.workcation_no
    // =========================================================
    ...
    // empName
    //
    // amount 테이블에는 emp_name 컬럼이 없으므로
    // @Transient 조회용 프로퍼티로 처리
    // =========================================================
    ...
    public String getEmpName() {
        ...
        if (workcationInfo.getEmployee() == null) {
            return null;
        }

        return workcationInfo.getEmployee().getEmpName();
    }
