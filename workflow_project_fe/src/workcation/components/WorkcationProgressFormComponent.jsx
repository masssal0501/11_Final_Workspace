...
function WorkcationProgressComponent() {
    ...
    if (!detailData) {
        return <div className="workcation-detail-container"><h2 align="center">로딩 중...</h2></div>;
    }
...
export default WorkcationProgressComponent;